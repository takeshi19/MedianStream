 ...
 * (the root of the tree), as the minimum value of all of the nodes.
 *
 * <p>Bugs: N/A
 *
...
public class MinPQ<E extends Comparable<E>> implements PriorityQueueADT<E>
{
	...
	/**
	 * Removes the minimum value from the MinPQ. In this case it would be the root value that holds the smallest node.
	 ...
	 * @throws EmptyQueueException if removal tries to occur from an empty MinPQ.
	 */
	@Override
